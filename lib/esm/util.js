...
exports.http = exports.browserDownloadBlob = exports.isColorLight = exports.getRandomHexColor = exports.getCreditCardBrand = exports.bytesToSize = void 0;
...
function http() {
    ...
    function findParams(url, params) {
        return url.split('/').reduce((acc, part) => {
            const param = part.startsWith('$') ? part : undefined;
            if (param) {
    ...
    return {
        ...
        url(url, ...parameters) {
            ...
            const baseUrl = normalizeUrl(replaceParams([`${protocol}://${domain}`, ...path].join('/'), kvPairsToRecord(parameters, params)));
            ...
            return (0, object_1.splitSegmentsToObjectFields)(paths, {
                ...
                finalValue: index => {
                    ...
                    return {
                        ...
                        get(...parameters) {
                            const _params = kvPairsToRecord(parameters, Object.assign({}, this._params));
                            return requestFn('GET', Object.assign(Object.assign({}, this), { _params }));
                        },
                        post(...parameters) {
                            const _params = kvPairsToRecord(parameters, Object.assign({}, this._params));
                            return requestFn('POST', Object.assign(Object.assign({}, this), { _params }));
                        },
                        put(...parameters) {
                            const _params = kvPairsToRecord(parameters, Object.assign({}, this._params));
                            return requestFn('PUT', Object.assign(Object.assign({}, this), { _params }));
                        },
                        patch(...parameters) {
                            const _params = kvPairsToRecord(parameters, Object.assign({}, this._params));
                            return requestFn('PATCH', Object.assign(Object.assign({}, this), { _params }));
                        },
                        delete(...parameters) {
                            const _params = kvPairsToRecord(parameters, Object.assign({}, this._params));
                            return requestFn('DELETE', Object.assign(Object.assign({}, this), { _params }));
                        }
                    };
                }
            });
