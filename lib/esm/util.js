...
export function http() {
    ...
    class Http {
        ...
        request(method) {
            ...
            const { baseUrl: url } = parseUrl([_baseUrl, __classPrivateFieldGet(this, _Http_endpoint, "f")].join('/'), _params);
        ...
        url(url, ...parameters) {
            const { baseUrl, protocol, domain, query, params } = parseUrl(url, kvPairsToRecord(parameters));
