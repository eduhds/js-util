...
exports.listObjectDeepKeys = exports.splitSegmentsToObjectFields = exports.remapProperties = exports.blobToJson = exports.jsonToBlob = exports.setValueAtPath = exports.getValueAtPath = exports.keySelect = void 0;
/**
 ...
 */
function splitSegmentsToObjectFields(segments, options) {
...
exports.splitSegmentsToObjectFields = splitSegmentsToObjectFields;
/**
 ...
 */
function listObjectDeepKeys(obj, prefix = '') {
    let keysAndTypes = [];
    for (const key in obj) {
        const path = prefix ? `${prefix}.${key}` : key;
        keysAndTypes.push([path, typeof obj[key]]);
        if (typeof obj[key] === 'object') {
            keysAndTypes = [...keysAndTypes, ...listObjectDeepKeys(obj[key], path)];
        }
    }
    return keysAndTypes;
}
exports.listObjectDeepKeys = listObjectDeepKeys;
