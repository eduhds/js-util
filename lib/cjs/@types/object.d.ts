...
export type SegmentsToObject<T extends string, S extends SplitCharacter, F> = T extends `${infer H}${S}${infer R}` ? {
...
export type MergeAll<T extends object> = T extends [infer A, ...infer R extends object[]] ? Merge<A & {}, MergeAll<R>> : {};
